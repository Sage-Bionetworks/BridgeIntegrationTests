...
public class TemplateTest {
    ...
    public void crudTemplate() throws Exception {
        ...
        // physically delete
        ForAdminsApi adminsApi = admin.getClient(ForAdminsApi.class);
        adminsApi.deleteTemplate(keys.getGuid(), true).execute();        
        
        // it's really deleted
        try {
            devsApi.getTemplate(keys.getGuid()).execute();
    ...
    public void templateRevisionTest() throws Exception {
        ...
        revision1.setDocumentContent("Content 1 ${url}");
        ...
        revision2.setDocumentContent("Content 2 ${url}");
        ...
        assertEquals("Content 1 ${url}", pubRevision.getDocumentContent());
